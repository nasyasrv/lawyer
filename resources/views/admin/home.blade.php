...
<div class="container-xxl flex-grow-1 container-p-y">
              <div class="row g-6">
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="card h-100">
                    <div class="card-header pb-0">
                      <h5 class="mb-3 card-title">Jumlah Jurnal</h5>
                      <h4 class="mb-3">{{$jurnals}}</h4>
                    </div>
                  </div>
                </div>
                <div class="col-xl-3 col-sm-6">
                  <div class="card h-100">
                    <div class="card-header pb-0">
                      <h5 class="mb-3 card-title">Jumlah Opini</h5>
                      <h4 class="mb-3">{{$opinies}}</h4>
                    </div>
                  </div>
                </div>
                <div class="col-xl-3 col-sm-6">
                  <div class="card h-100">
                    <div class="card-header pb-0">
                      <h5 class="mb-3 card-title">Jumlah Berita</h5>
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="card h-100">
                    <div class="card-header pb-0">
                      <h5 class="mb-3 card-title">Jumlah Patner</h5>
                      <h4 class="mb-3">{{$patners}}</h4>
                    </div>
                  </div>
                </div>
                <!--/ Average Daily Sales -->
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="card">
                        <div class="d-flex align-items-center justify-content-between">
                            <h5 class="card-header">Rating dan Ulasan</h5>
                        </div>
